...
int alphaBeta(GameTreeNode node, int alpha, int beta, int depth,
              bool isMaximizer) {
    if (depth == 0) { return node.getEvaluationScore(); }
    // TODO alpha-beta剪枝过程
    return 0;
}
